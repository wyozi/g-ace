...
define('ace/mode/glua_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/glua/gluaparse'], function(require, exports, module) {


var oop = require("../lib/oop");
var Mirror = require("../worker/mirror").Mirror;
var luaparse = require("../mode/glua/gluaparse");
...
define('ace/mode/glua/gluaparse', ['require', 'exports', 'module' ], function(require, exports, module) {
...
(function (root, name, factory) {
  ...
  function isUnary(token) {
    if (Punctuator === token.type) return '!' === token.value || '#-'.indexOf(token.value) >= 0;
